package be.civadis.financeservice.web.rest;

import be.civadis.financeservice.domain.ArticleBudg;
import be.civadis.financeservice.repository.ArticleRepository;
import be.civadis.financeservice.web.rest.util.PaginationUtil;
